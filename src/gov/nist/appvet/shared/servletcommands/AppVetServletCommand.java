...
/**
 * Enumeration of AppVet servlet commands.
 * 
 * @author steveq@nist.gov
 */
public enum AppVetServletCommand {
	// HTTP GET
	GET_APP_STATUS, GET_APP_TOOLS_STATUS, GET_APP_TOOL_IDS, GET_ALL_TOOL_IDS, 
		GET_TOOL_REPORT, GET_APP_LOG, GET_APPVET_LOG,
	// HTTP POST
	DOWNLOAD_REPORTS, SUBMIT_APP, SUBMIT_APP_METADATA, SUBMIT_REPORT;
