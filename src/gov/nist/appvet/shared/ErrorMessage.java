...
public enum ErrorMessage {
	INVALID_FILE("ERROR: INVALID FILE ATTACHMENT"), INVALID_APP_FILE(
			"ERROR: INVALID APP FILE"), INVALID_APP_FILE_EXTENSION(
			"ERROR: INVALID APP FILE EXTENSION"), INVALID_REPORT_FILE_EXTENSION(
			"ERROR: INVALID REPORT FILE EXTENSION"), INVALID_APPID(
			...
			"ERROR: COULD NOT AUTHENTICATE USER"), INVALID_COMMAND(
